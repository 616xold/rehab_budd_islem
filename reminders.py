"""
reminders.py - Alexa Reminders API integration for Rehab Buddy Alexa Skill
...
def schedule_daily_reminder(
    ...
    """
    if not config.REMINDERS_ENABLED:
        return False, "Reminders feature is disabled"
...
def build_permissions_response(handler_input) -> Dict[str, Any]:
    ...
    try:
        ...
        permissions_card = AskForPermissionsConsentCard(
            permissions=[config.REMINDERS_PERMISSION]
        )
